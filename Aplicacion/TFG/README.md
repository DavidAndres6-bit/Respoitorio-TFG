...
Aplicación desarrollada como trabajo final de grado del ciclo de **Desarrollo de Aplicaciones Multiplataforma** utilizando JavaFX para su desarrollo.

## Organización y Distribución de Recursos

Para mantener la organización y separación de funciones en la aplicación, el código se ha organizado siguiendo la siguiente estructura:
