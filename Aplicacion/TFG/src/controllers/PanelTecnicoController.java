...
public class PanelTecnicoController {
    ...
    */
    ...
    public void mostrarInspeccionesVehiculo(String matricula){
        //Instancia de la clase InspeccionDAO
    ...
    */
    ...
    /**
     * Función para pasar a la siguiente ventana y empezar la inspeccion
    */
    ...
    private void accionIniciarInspeccion(ActionEvent event) {
        ...
        if (matricula.isEmpty()) {
            ...
            if (InspeccionDAO.existeInspeccionHoy(matricula)) {
                Utilities.mostrarAlerta("Inspeccion ya realizada", "El vehículo con matrícula " + matricula + " ya ha realizado una inspección en el día de hoy.\n\nNo se permiten duplicados diarios.", Alert.AlertType.WARNING); 
            } else {
