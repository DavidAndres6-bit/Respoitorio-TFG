    ...
    private void validarCampos() {
        ...
        try {
            ...
            if (actStr.isEmpty()) {
                ...
                // Impedimos que los kmActuales sean menores que los de la anterior inspeccion y el límite sea de 999.999km
    ...
    private void accionSiguiente(ActionEvent event) {
        try {
            ...
            if (txtKmAnteriores.isDisable() || txtKmAnteriores.getText().trim().isEmpty()) {
                kmAnt = 0; // Si está deshabilitado o vacío setteamos 0
            } else {
