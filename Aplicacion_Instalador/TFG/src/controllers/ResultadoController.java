...
public class ResultadoController {
    ...
    private void accionGenerarInforme() {
        ...
        if (spResultado.getValue() == null || dpFecha.getValue() == null) {
            Utilities.mostrarAlerta("Error", "Rellena todos los campos para poder generar el informe.",
            ...
            if (insertado) {
                ...
                generador.generarInformeITV(BufferInspeccion.getInspeccionActual(),
                        BufferInspeccion.getDefectosActuales(), carpetaDescargas);
                ...
                alerta.setContentText(
                        "El informe técnico se ha guardado en la carpeta 'Descargas'.\n\nAl aceptar, volverá al panel principal.");
    ...
    private boolean insertarInspeccion() {
        ...
        // Si el id es 0 o -1, significa que es el cliente nuevo que creamos en
        // AltaCliente
        if (idCliente <= 0) {
        ...
        // Realiza el insert
        insertado = InspeccionDAO.guardarInspeccion(BufferInspeccion.getInspeccionActual(),
                BufferInspeccion.getDefectosActuales());
